...
func (c *InformeSeguimientoController) GenerateInformeSeguimiento() {
	...
	if data, err := helpers_supervisor.CreateInformeSeguimiento(v.NumeroContratoSuscrito, v.VigenciaContrato, v.TipoPago, v.PeiodoInicio, v.PeriodoFin, v.TipoSoportePagar, v.NumeroCuentaFactura, v.ValorPagar, v.TipoCuenta, v.NumeroCuenta, v.Banco); err == nil {
